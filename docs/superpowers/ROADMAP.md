...
- [ ] **Data-gated:** §5.3 expected overall-rank change — needs 5 graded gameweeks carrying both `my_points` and `overall_rank` in `reports/decision_ledger.json`. Two are graded today (GW1, GW2)
